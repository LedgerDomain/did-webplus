...
pub trait VJSONResolver: Send + Sync {
    ...
    async fn resolve_vjson_string(&self, self_hash: &mbx::MBHashStr) -> Result<String>;
    ...
    async fn resolve_vjson_value(&self, self_hash: &mbx::MBHashStr) -> Result<serde_json::Value> {
