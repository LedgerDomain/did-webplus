...
The idea is:
-   Each DID has an associated microledger of DID documents; each DID document references the SAID of the previous DID document.  The microledger is intended to be immutable and append-only, and provides a totally-ordered sequence of DID documents whose validity durations are non-overlapping.
