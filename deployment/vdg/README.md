...
export HELM_IMG_TAG="vdg-initial-release-v3"

# demo
export SERVICE_NAME="vdg"
export CI_ENVIRONMENT_SLUG="demo"
export K8S_NAMESPACE=$CI_ENVIRONMENT_SLUG
export HELM_CHART=$SERVICE_NAME
export CURRENT_HELM_CHART=$SERVICE_NAME
export HELM_IMG_TAG="dev-0abf3fd32b11d9479f6cc45e715113802545dd47"

# qa
export SERVICE_NAME="vdg"
export CI_ENVIRONMENT_SLUG="qa"
export K8S_NAMESPACE=$CI_ENVIRONMENT_SLUG
export HELM_CHART=$SERVICE_NAME
export CURRENT_HELM_CHART=$SERVICE_NAME
export HELM_IMG_TAG="dev-0abf3fd32b11d9479f6cc45e715113802545dd47"
