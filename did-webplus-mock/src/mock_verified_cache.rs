...
// impl<'v> did_webplus::MicroledgerViewTrait<'v> for MicroledgerMutView<'v> {
//     fn did(&self) -> &'v DIDWebplus {
//         // use std::borrow::Borrow;
//         self.mock_verified_cache
//             .as_ref()
//             // .borrow()
//             .did::<'v>(self.did_primary_key)
...
//         // .did(self.did_primary_key)
//     }
//     fn root_did_document(&self) -> &'v RootDIDDocument {
//         let root_did_document_primary_key = *self
//             .mock_verified_cache
//             .did_version_id_m
//             .get(&(self.did_primary_key, 0))
...
//         version_id_begin_o: Option<u32>,
//         version_id_end_o: Option<u32>,
//     ) -> Box<dyn std::iter::Iterator<Item = &'v DIDDocument>> {
//         let version_id_begin = version_id_begin_o.unwrap_or(0);
//         let version_id_end = version_id_end_o.unwrap_or(u32::MAX);
//         Box::new(
//             self.mock_verified_cache
