...
pub trait DIDDocStorage: Sync {
    ...
    /// Note that did_document and did_document_body are redundant, and are expected to be consistent, but
    /// did_document_body is required because the specific string representation of the DID document is needed
